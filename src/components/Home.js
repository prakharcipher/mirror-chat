		...
		return (
			  <div style={{width: '100%', height: '200px'}}>
				...
				<div style={{position: 'fixed', bottom: '0px', left: '0px', width: '100%'}}>
					<input style={{width: '80%'}} type="text" placeholder="Your text" value={this.state.message} onChange={(e) => this.setState({message: e.target.value})} onKeyDown={(e) => {
						if(e.key === 'Enter') {
